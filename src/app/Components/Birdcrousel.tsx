            ...
            <div className=" max-w-5xl mx-auto bg-[url(/images/crousel/crouselbg.png)] py-[30px] rounded-[20px] shadow-2xl  bg-cover">
                        ...
                        <div className="flex justify-center relative z-10 mt-4 space-x-2">
                            <div className="flex justify-center items-center relative gap-5 z-10 mt-4 space-x-2">
                                <button
                                    className={`px-4 py-2 uppercase rounded-lg ${activeIndex === 0 ? 'text-5xl font-black text-[#74a81a]' : ' text-5xl font-black text-textbrown '}`}
                                ...
                                <button
                                    className={`px-4 py-2 uppercase rounded-lg ${activeIndex === 1 ? 'text-5xl font-black text-[#74a81a]' : ' text-5xl font-black text-textbrown '}`}
                                ...
                                <Image src="/images/diamond.webp" alt="Diamond" className="w-6 h-10" width={200} height={200} />
                                <button
                                    className={`px-4 py-2 uppercase rounded-lg ${activeIndex === 2 ? 'text-5xl font-black text-[#74a81a]' : ' text-5xl font-black text-textbrown '}`}
